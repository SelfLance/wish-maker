...
const FONT_MSG = { xl: 21, lg: 14, md: 12, sm: 10 };
const FONT_FROM = { xl: 22, lg: 15, md: 13, sm: 11 };
...
export default function WishCard({
  ...
  const msgFz = FONT_MSG[size] || 14;
  const fromFz = FONT_FROM[size] || 15;
  ...
  return (
    <div
      ...
      style={{
        ...
        filter:
          hovered || glow
            ? "drop-shadow(0 16px 44px rgba(0,0,0,0.14)) drop-shadow(0 0 32px rgba(201,162,39,0.50))"
            : "drop-shadow(0 16px 44px rgba(0,0,0,0.14))",
    ...
    >
      ...
      <div className={resCls} style={coverSt}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(130deg,rgba(255,255,255,0.30) 0%,transparent 60%)",
            pointerEvents: "none",
          }}
        />
        ...
        {orderSummary ? (
          ...
          >
            ...
            >
              {[
                "Permanent digital wish",
                "Shareable wish link",
                "Printed keepsake card",
              ].map((f) => (
                <div key={f}>
                  <span
                    style={{ color: GOLD, marginRight: 4, fontWeight: 700 }}
                  >
                    ✓
                  </span>
                  {f}
      ...
      <div className={resCls} style={innerSt}>
        ...
        >
          {msg ? (
            ...
            <>
              ...
              >
                Create a loving message, written permanently into time,
                delivered digitally and as a beautifully printed card to your
                loved one’s home.
              </p>
        ...
        <div
          style={{
            paddingTop: 9,
            borderTop: "1px dashed rgba(184,150,12,0.24)",
            textAlign: "center",
          }}
        >
          <span
